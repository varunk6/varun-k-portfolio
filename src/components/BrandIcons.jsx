// Lucide's icon set no longer ships third-party brand marks, so these are
// small original line-icon glyphs used consistently across the site.
...
export function LinkedinMark({ size = 18, className = "" }) {
  return (
    ...
    >
      ...
      <path d="M11.5 16.5V10m0 3c0-1.7 1-3 2.6-3 1.5 0 2.4 1 2.4 3v3.5" />
    </svg>
  );
}

export function InstagramMark({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
