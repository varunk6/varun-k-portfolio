...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // No backend/email service is connected yet. This structures the data
    // so a service (e.g. Formspree, EmailJS, or a custom API route) can be
    // wired in later — for now it opens a pre-filled mail draft.
    ...
    <section id="contact" className="relative py-24 md:py-32 pb-32 md:pb-32">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 grid md:grid-cols-2 gap-14 md:gap-16">
        <div>
          ...
          <div className="mt-8 text-sm font-mono text-ink-soft flex items-center gap-2">
